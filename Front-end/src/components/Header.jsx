      ...
      <Navbar className="border-b-2 m-4">
        ...
        <form>
          <input
            type="search"
            id="default-search"
            className="hidden md:flex w-full p-2 ps-6 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 m-2"
            placeholder="Search ..."
          />
        </form>
        ...
        <Navbar.Collapse>
          ...
          <Navbar.Link as={Link} to="/signup">Sign Up</Navbar.Link>
        </Navbar.Collapse>
