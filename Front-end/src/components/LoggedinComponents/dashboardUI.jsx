...
{/* Div line start here --------------------------- */}
  ...
  <div className="p-2 mb-2">
    <p className="block font-sans text-sm antialiased font-semibold leading-snug tracking-normal text-blue-gray-500">
      Blago
    </p>
  </div>
 ...
 {/* Div Slide start here --------------------------- */}
  ...
  <nav className="flex min-w-[240px] flex-col gap-1 p-2 font-sans text-sm font-normal text-blue-gray-400 h-full">
    <div role="button"
